...
const GroupField = ({ data, parentJsonKey, register, watch, getValues }) => {
	...
	return (
		<div className="my-2 bg-gray-50 rounded-lg p-6 w-full transition-all duration-200">
			<h1 className="font-bold w-full flex items-center transition-all duration-200">
				{data.label} &nbsp;
			...
			<div className="mt-4 mb-2 flex items-center transition-all duration-200">
				<input
					type="checkbox"
					value={showAdvanced}
